...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jproperties-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13249&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jproperties-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jproperties` can be installed with:

```
conda install jproperties
```

It is possible to list all of the versions of `jproperties` available on your platform with:
